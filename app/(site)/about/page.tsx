...
export const metadata: Metadata = {
  title: "About bountychallenge",
  description: "About bountychallenge",
  // other metadata
};
...
const AboutPage = () => {
  return (
    <>
<section
    className="pt-40 pb-20 lg:pt-[120px] lg:pb-[90px] bg-white dark:bg-dark"
   >
               ...
               <div  className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div  className="relative z-10 my-4">
                     <img
                        ...
                        alt="Autonomous Agents For The Web"
                         className="w-full rounded-2xl"
                        />
