      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `Integrations`,
              subtitle: `Core and Partner Platforms`,
              description: ``
            }}
          />
            ...
            >
              <div className="inline-block rounded-[10px] shadow-solid-7 bg-white dark:bg-btndark p-4.5">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/brand-facebook.svg"
                  alt="Facebook"
                />
              </div>
            ...
            >
              <div className="inline-block rounded-[10px] shadow-solid-7 bg-white dark:bg-btndark p-4.5">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/brand-aws.svg"
                  alt="aws"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] shadow-solid-7 bg-white dark:bg-btndark p-4.5">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/brand-vercel.svg"
                  alt="Vercel"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] shadow-solid-7 bg-white dark:bg-btndark p-4.5">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/brand-cloudflare.svg"
                  alt="Cloudflare"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] shadow-solid-7 bg-white dark:bg-btndark p-4.5">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/brand-wordpress.svg"
                  alt="Wordpress"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] shadow-solid-7 bg-white dark:bg-btndark p-4.5">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/brand-shopify.svg"
                  alt="Shopify"
                />
              </div>
            </motion.div>
