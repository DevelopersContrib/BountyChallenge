...
const PrivacyPolicyText = () => {
  ...
  return (
    <>
        ...
        <div className="mx-auto p-2 bg-gradient-to-r from-white via-purple-100 to-primary-200 max-w-prose w-full md:w-[850px] sm:w-4/5">
            ...
            <div className="blog-details">
                ...
                <p>
                    bountychallenge.com,LLC.(Bountychallenge.com)is committed to protecting your privacy.We have prepared this Privacy Policy to describe to you 
                    our practices regarding the Personal Data(as defined below)we collect from users of our website,located at Bountychallenge.com(the"Site")and online service("Service").
                </p>
                <h2>Privacy Statement Overview</h2>
                <p>
                    Your privacy is important to us and Bountychallenge.com is committed to protecting the privacy of its users and the information that You share in connection with Our Service.Our Privacy Notice 
                    ...
                    and manage Your Personal Data and informs You of Your rights with respect the privacy practices associated with the,use,and disclosure of Personal Data through the Site and Service.Bountychallenge.com may 
                    provide additional notices through the Site or Service in addition to these practices or provide You additional choices about how Bountychallenge.com may process Your Personal Data.
                ...
                <p>This Privacy Notice describes Bountychallenge.com"s collection,use,and 
                ...
                <p>This Privacy Notice describes Bountychallenge.com"s collection,use,and disclosure of the information You provide to Us through Your use of the Site or Service,as well as the rights You have with respect to Your Personal Data.For any questions regarding this Privacy Notice please contact Us     at 
    ...
    interact with other users through the Site or Service.We may also collect Personal Data when You sign up for marketing emails,events,or other opportunities through Bountychallenge.com.Personal Data may contain 
    Your name,email,contact information,as well as job titles,or other information You provide to Bountychallenge.com.</p><p>&gt;Billing and transactional information pursuant to Your use of the Site 
    and 
   ...
   ><b>Business Partners.</b></p><p>We may share Your Personal Data with Our channel partners to fulfill obligations and requests,to deliver support,and to provide users and Our 
    customer"s users with information about Bountychallenge.com.Bountychallenge.com does not control how a business partner may use Your Personal Data.Our business partners are responsible for managing the use of Personal 
    ...
    be 
    necessary for other legitimate purposes as reasonably determined by Bountychallenge.com.</p><h2>III.International Transfers of Information</h2><p>Information,including information collected in the 
    ...
    laws.These steps include obligations to both Bountychallenge.com and You and available on Bountychallenge.com.You may also request an executable version of Bountychallenge.com"s Data Processing Agreement by contacting 
    support@CONTRIB.com.</p><h2>IV.Information Security and Confidentiality</h2><p>Bountychallenge.com maintains(and requires its subcontractors and service providers to maintain)appropriate 
    ...
    care when disclosing information online and act reasonably to protect Yourself online.</p><h2>V.Privacy Rights</h2><p>You may modify the information You have provided to Bountychallenge.com at any 
    time through Your Bountychallenge.com profile.You can also opt-out of receiving marketing communications,deactivate,or delete Your account at any time.</p><h2>VI.Additional Rights for EEA users or similar 
    ...
    You.</p><p 
   >&gt;Right to object to processing:You may have the right to request that Bountychallenge.com stop processing Your Personal Data and/or to stop sending You marketing communications.</p><p 
   ...
   >The Bountychallenge.com Site and Service may link to other websites or services.Other websites may also contain links to the Bountychallenge.com Site or Service.Bountychallenge.com does not control those 
    websites 
    or their privacy practices.The personal information You choose to give to such parties is not covered by this Privacy Notice or the Bountychallenge.com Privacy Policy.</p><p><b>Changes to this 
    Privacy Notice</b></p><p>Bountychallenge.com will review and update this Privacy Notice in response to changing legal,technical and business developments.Please review this Privacy Notice 
    frequently 
    to understand how Bountychallenge.com is protecting Your Personal Data.</p><p><b>Data Protection Officer</b></p><p>Bountychallenge.com has appointed a Data Protection Officer to ensure 
    ...
    detail Bountychallenge.com"s collection,processing,and treatment of Your information,as well as the rights You have with respect to such information.This Privacy Policy will provide You with further technical 
   ...
   >We do not intentionally gather Personal Data from visitors who are under the age of 13.If a child under 13 submits Personal Data to Bountychallenge.com and We learn that the Personal Data is the 
   ...
   ><b>(c)Information Collected From Address Book and Contact Importing</b></p><p>You may use Our address book and contacts importer to upload Your contacts from other services into 
    Bountychallenge.com.When You import Your contacts,We may indefinitely store the contact information in Our database,including Your contacts'names,e-mails,phone numbers,locations,and relationships to You,subject 
   ...
   >In general,Personal Data You submit to Us is used either to respond to requests that You make,or to aid Us in serving You better.We use Your Personal Data in the following ways:facilitate 
    ...
    promotional materials related to the Site or Service and for other marketing purposes of Bountychallenge.com.</p><p><b>(b)User Testimonials And Feedback</b></p><p>We often receive 
    ...
    other 
    services to Bountychallenge.com.These third party service providers are required not to use Your Personal Data other than to provide the services requested by Bountychallenge.com.</p><p 
   ...
   ><b>(f)Public Profile</b></p><p>Certain portions of the information You provide to us may also be displayed in Your Profile.As an essential element of the Service,most of the 
    ...
    engines).</p><p><b>(g)Other Disclosures</b></p><p>Regardless of any choices You make regarding Your Personal Data(as described below),Bountychallenge.com may disclose Personal Data if 
    it 
    believes in good faith that such disclosure is necessary(a)in connection with any legal investigation;(b)to comply with relevant laws or to respond to subpoenas or warrants served on Bountychallenge.com;(c)to 
    protect or defend the rights or property of Bountychallenge.com or users of the Site or Service;and/or(d)to investigate or assist in preventing any violation or potential violation of the law,this Privacy 
   ...
   ><b>(a)Email Communications</b></p><p>We will periodically send You free newsletters and e-mails that directly promote the use of Our Site or Service.When You receive newsletters 
    ...
    Security 
    Of Your Personal Data</h2><p>Bountychallenge.com is committed to protecting the security of Your Personal Data.We use a variety of industry-standard security technologies and procedures to help 
    ...
    unauthorized 
    people.No method of transmission over the Internet,or method of electronic storage,is 100%secure,however.Therefore,while Bountychallenge.com uses reasonable efforts to Your Personal Data,Bountychallenge.com cannot 
